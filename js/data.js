...
window.FRIGHT_DATA = {
  ...
  /* "REAL PEOPLE. REAL FEAR." carousel.
     Thumbnails come from js/assets-manifest.js (FRIGHT_ASSETS.videos[i] ->
     assets/img/videos/fear-0X/image.png). A missing image falls back to a
     generated scary-face. Set youtubeId to embed a real clip in the player. */
  videos: [
